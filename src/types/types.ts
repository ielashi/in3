...
export interface IN3Config {
    ...
    minDeposit: number
    /**
     * amount of time the deposit is locked after the server unregister himself in seconds
     */
