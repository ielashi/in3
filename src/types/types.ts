...
export interface IN3RPCRequestConfig {
    ...
    useRef?: boolean
    /**
     * if true binary-data will be send as result.
     */
    useBinary?: boolean
    /**
